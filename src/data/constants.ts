...
image: string;
hint: string;
component?: 'CustomerSalesChart' | 'PratilipiMarketAnalysisChart' | 'WattpadAnalysisChart' | 'AirbnbAnalysisChart' | 'NetflixDashboard' | 'SpotifyDashboard' | 'BankLoanAnalyticsDashboard' | 'FitnessDashboard' | 'SmartphoneMarketAnalysisDashboard' | 'SqlDataWarehouse';
tools: string[];
achievements: string[];
};
